    ...
    <div class="modal-content">
        ...
        <div class="about-section">
            ...
            <div class="about-image">
                <img src="pi/mac.png" alt="Image 1">
                <div class="image-description">
                    <label>Mark Jay Macaballug</label>
            ...
            <div class="about-image">
                <img src="pi/dennis.png" alt="Image 2">
                <div class="image-description">
                    <label>Dennis Malsi</label>
            ...
            <div class="about-image">
                <img src="pi/jc.png" alt="Image 3">
                <div class="image-description">
                    <label>Jaycie Quilang</label>
                    <label>Sta. Maria Isabela</label>
                    <label>BSIT 2B</label>
                </div>
            </div>
        </div>
